google.load('visualization', 1.0);
      ...
      function handleQueryResponse(response){
        ...
        document.styleSheets[0].insertRule('.halfStyle.hs-vertical-third:before { width:' + greenPercent + '%; }', 0);
        document.styleSheets[0].insertRule('.halfStyle.hs-vertical-third:after { width:' + purplePercent + '%; }', 0);
      }